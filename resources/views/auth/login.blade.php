<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block mt-1 w-full bg-gray-100 text-black border-gray-300 focus:ring-indigo-500" type="password" name="password" required autocomplete="current-password" />
